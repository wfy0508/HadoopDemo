package com.old.common_friends_step2;
...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        TextInputFormat.addInputPath(job, new Path(hdfsUri + "/step1_output"));
        ...
        TextOutputFormat.setOutputPath(job, new Path(hdfsUri + "/step2_output"));
        FileSystem fileSystem = FileSystem.get(URI.create(hdfsUri), new Configuration());
        Path outputPath = new Path(hdfsUri + "/step2_output");
